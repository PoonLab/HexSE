setwd('/home/laura/Projects/ovrf/temp/sysv')

no_ov <- read.csv('hyphy_no_overlaps.csv')
ov <- read.csv('sysv_selection.csv')
...
plot(ov$Codon, ov$alpha, main = "alpha values, CDS with overlap", xlab = "")
#plot(no_ov$beta, main = "beta values, CDS with no overlap", xlab = "")
plot(ov$Codon, ov$beta, main = "beta values, CDS with overlap", xlab = "")
