...
from hexse.run_simulation import omegas_in_orf
...
class TestSequence1(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.orf = {'coords': [[0, 21]],
                    ...
                    'ds_values': [0.6137056388801096, 3.386294361119891],
                    'orf_map': np.array([1])}
        self.all_coords = [orf['coords'] for strand in self.orfs for orf in self.orfs[strand]]
    ...
    def testSetSubstitutionRates(self):
        ...
        exp_omega_keys = {'A': (0.12575458287886826,),
                          'C': (0.12575458287886826,),
                          'G': None,
        ...
        exp_total_omegas = {(0.12575458287886826,): {'nt_events': 1, 'value': 0.12575458287886826},
                            (0.5270709191984724,): {'nt_events': 1, 'value': 0.5270709191984724},
                            (0.6137056388801096,): {'nt_events': 1, 'value': 1},
                            (1.532074860270361,): {'nt_events': 1, 'value': 1.532074860270361},
                            (2.9082628030744515,): {'nt_events': 1, 'value': 2.9082628030744515},
                            (3.386294361119891,): {'nt_events': 1, 'value': 1},
                            (8.45365616912733,): {'nt_events': 1, 'value': 8.45365616912733}}
   ...
   'T': {'from_nt': {'A': {'mu1': {'nt_events': 0,
    ...
    @unittest.skip('get_mutation_rate is no longer defined')
    ...
    def testCheckMutationRates(self):
        exp_sub_rates = [
                ...
                {'A': None, 'C': 5.46517972935242e-06, 'G': 1.8217265764508066e-05, 'T': 1.5070521255236873e-05},
                {'A': 5.46517972935242e-06, 'C': None, 'G': 2.806839009386231e-05, 'T': None},
                {'A': 6.401822064594056e-05, 'C': 1.920546619378217e-05, 'G': None, 'T': 5.296008563737085e-05},
                {'A': None, 'C': 4.4118202240945026e-05, 'G': 5.023507085078958e-05, 'T': 2.3193254860093468e-05},
                ...
                {'A': 7.498052606855045e-06, 'C': 1.821021318341122e-05, 'G': None, 'T': 5.3309494374475237e-05},
                ...
                {'A': 1.5070521255236873e-05, 'C': None, 'G': 0.00019606780203017157, 'T': 0.00014706067413648342},
                ...
                {'A': 9.811875673722017e-07, 'C': 7.73108495336449e-05, 'G': 2.3253421408519e-05, 'T': None},
                ...
                {'A': 9.651256435350337e-06, 'C': 3.217085478450112e-05, 'G': 9.651256435350337e-06, 'T': None},
...
{'A': 2.8520883061938023e-06, 'C': None, 'G': 1.4786447354622791e-05, 'T': 5.023507085078958e-05}
            ]

        exp_total_rates = [
            2.6701125559524848e-05,
            2.2283927962357505e-05,
            3.875296674909736e-05,
            3.353356982321473e-05,
            0.00013618377247709358,
            0.00011754652795182808,
            9.319502501793524e-05,
            9.175033650901792e-05,
            7.90177601647415e-05,
            0.0006214852596866318,
            0.001305138329017783,
            0.0003581989974218918,
            5.656979817419496e-05,
            5.3778430619311096e-05,
            0.00010154545850953612,
            0.0005699148360238426,
            0.0006234504952938797,
            5.1473367655201795e-05,
            0.0002957524386187871,
            0.00018888862790957976,
            6.787360651160618e-05
        ]
    ...
    def testOmegasInOrf(self):
        expected = {'[[0, 21]]': [0.12575458287886826,
                                  2.9082628030744515,
                                  1.532074860270361,
                                  8.45365616912733,
                                  0.5270709191984724,
                                  2.9082628030744515,
                                  1.532074860270361]}
        result = omegas_in_orf(self.sequence1)
...
class TestSequence2(unittest.TestCase):
    ...
    def testSetSubstitutionRates(self):
        ...
        exp_sub_rates = {'A': 5.97876765413153e-06,
                         'C': None,
                         'G': 1.7502545270286303e-05,
                         'T': 7.227142144251374e-06}
        self.assertEqual(exp_sub_rates, nt.rates)

        exp_omega_keys = {'A': (0.6137056388801096, 0.5600744006011661),
                          'C': None,
                          'G': (0.6137056388801096, 0.5600744006011661),
                          'T': (0.6137056388801096, 0.5600744006011661)}
        self.assertEqual(exp_omega_keys, nt.omega_keys)

        exp_cat_keys = {'A': 'mu4', 'G': 'mu6', 'T': 'mu2'}
        self.assertEqual(exp_cat_keys, nt.cat_keys)

        exp_total_rate = 3.070845506866921e-05
        self.assertEqual(exp_total_rate, nt.mutation_rate)

        exp_total_omegas = {(0.6137056388801096, 0.5600744006011661): {'nt_events': 1,
                                                                       'value': 0.5600744006011661},
                            (0.7046919454251792, 0.6137056388801096): {'nt_events': 1,
                                                                       'value': 0.7046919454251792},
                            (0.7046919454251792, 3.090368842013911): {'nt_events': 1,
                                                                      'value': 2.177758031360141},
                            (3.386294361119891, 3.090368842013911): {'nt_events': 1,
                                                                     'value': 3.090368842013911},
                            (3.888337029906392, 0.5600744006011661): {'nt_events': 1,
                                                                      'value': 2.177758031360141},
                            (3.888337029906392, 3.386294361119891): {'nt_events': 1,
                                                                     'value': 3.888337029906392}}
           ...
           'G': {'from_nt': {'A': {'mu1': {'nt_events': 0,
                                   ...
                                   'mu3': {'nt_events': 1,
                                           (1, 0): {'nt_events': 0,
                                                    'region_weight': 0},
                                           (1, 1): {'nt_events': 1,
                                                    'region_weight': 3.090368842013911,
                                   ...
                                   'mu5': {'nt_events': 1,
                                           (1, 0): {'nt_events': 0,
                                                    'region_weight': 0},
                                           (1, 1): {'nt_events': 1,
                                                    'region_weight': 0.7046919454251792,
                             ...
                             'C': {'mu1': {'nt_events': 2,
                                           (1, 0): {'nt_events': 0,
                                                    'region_weight': 0},
                                           (1, 1): {'nt_events': 2,
                                                    'region_weight': 6.066095061266533,
                                                    (3.888337029906392, 0.5600744006011661): [c10],
                                                    (3.888337029906392, 3.386294361119891): [c9]}},
                                   'mu2': {'nt_events': 0,
                                           (1, 0): {'nt_events': 0,
    ...
    def testCheckMutationRates(self):
        exp_sub_rates = [
            ...
            {'A': None, 'C': None, 'G': None, 'T': None},
            {'A': None, 'C': None, 'G': None, 'T': None},
            {'A': None, 'C': 2.182003825544377e-05, 'G': 9.988061042728549e-05, 'T': None},
            {'A': None, 'C': 7.432484984504838e-06, 'G': 7.273346085147923e-05, 'T': 3.8533185560467476e-05},
            {'A': None, 'C': 7.432484984504838e-06, 'G': 0.00018226964661945675, 'T': None},
            {'A': 2.6581864262742348e-05, 'C': None, 'G': 5.127250813015351e-06, 'T': 1.7090836043384503e-05},
            {'A': 2.32474636627662e-05, 'C': None, 'G': 2.871641925831414e-06, 'T': 4.962607231272327e-05},
            {'A': 2.1681426432754126e-06, 'C': None, 'G': 9.20121338891116e-06, 'T': 3.0670711296370534e-05},
            {'A': None, 'C': None, 'G': None, 'T': None},
            {'A': None, 'C': None, 'G': None, 'T': None},
            {'A': None, 'C': None, 'G': None, 'T': None},
            {'A': None, 'C': None, 'G': None, 'T': None},
        ...
        exp_total_rates = [
            ...
            0,
            0,
            0.00012170064868272925,
            0.00011869913139645155,
            0.0001897021316039616,
            4.8799951119142204e-05,
            7.574517790132089e-05,
            4.204006732855711e-05,
            0,
            0,
            0,
            0,
    ...
    def testOmegasInOrf(self):
        expected = {'[[0, 21]]': [3.888337029906392,
                                  3.888337029906392,
                                  0.7046919454251792,
                                  3.888337029906392,
                                  0.2953080545748205,
                                  0.7046919454251792],
                    '[[3, 15]]': [3.090368842013911,
                                  0.5600744006011661,
                                  3.090368842013911,
                                  9.945196571069815]}
        result = omegas_in_orf(self.sequence2)
...
class TestSequence3(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.all_coords = [orf['coords'] for strand in self.sorted_orfs for orf in self.sorted_orfs[strand]]
    ...
    def testSetSubstitutionRates(self):
        ...
        exp_total_omegas = {(0.6137056388801096,): {'nt_events': 1, 'value': 1},
                            (1.7453499770576755,): {'nt_events': 1, 'value': 1.7453499770576755},
                            (8.45365616912733,): {'nt_events': 1, 'value': 8.45365616912733}}
        ...
        exp_omega_keys = {'A': (0.6137056388801096,),
                          'C': (0.6137056388801096,),
                          'G': None,
                          'T': (0.6137056388801096,)}
        self.assertEqual(exp_omega_keys, nt.omega_keys)
        ...
        exp_event_tree = \
            {'to_nt': {'A': {'from_nt': {'A': None,
                    ...
                    'C': {'from_nt': {'A': {'mu1': {'nt_events': 0,
                                        ...
                                        'G': {'mu1': {'nt_events': 2,
                                                    (1,): {'nt_events': 2,
                                                            'region_weight': 9.45365616912733,
                                                            (0.6137056388801096,): [g5],
                                                            (8.45365616912733,): [g8]}},
                                            'mu2': {'nt_events': 0,
                                                    (1,): {'nt_events': 0,
    ...
    def testCheckMutationRates(self):
        exp_sub_rates = [
            ...
            {'A': 8.791137398888177e-05, 'C': 3.257774580909433e-06, 'G': None, 'T': 9.564064526366735e-06},
    ...
    def testOmegasInOrf(self):
        expected = {'[[0, 12]]': [0.31631364805076445,
                                  1.7453499770576755,
                                  8.45365616912733,
                                  0.31631364805076445]}
        result = omegas_in_orf(self.sequence3)
...
class TestSequence4(unittest.TestCase):
    ...
    def testSetSubstitutionRates(self):
        ...
        exp_total_omegas = {(0.8558730398605124,): {'nt_events': 1, 'value': 0.8558730398605124},
                            (1.774131041895811,): {'nt_events': 1, 'value': 1.774131041895811},
                            (3.386294361119891,): {'nt_events': 1, 'value': 1}}
    ...
    def testCheckMutationRates(self):
        exp_sub_rates = [
            ...
            {'A': 1.939151536255615e-06, 'C': None, 'G': 5.69289555140877e-06, 'T': 5.232819880290581e-05},
            {'A': None, 'C': None, 'G': None, 'T': None},
            {'A': None, 'C': None, 'G': None, 'T': None},
            {'A': None, 'C': None, 'G': None, 'T': None}
        ]
    ...
    def testOmegasInOrf(self):
        expected = {'[[0, 12]]': [0.3215297042763952,
                                  1.774131041895811,
                                  0.8558730398605124,
                                  0.3215297042763952]}
        result = omegas_in_orf(self.sequence4)
...
class TestSequence5(unittest.TestCase):
    ...
    def testSetSubstitutionRates(self):
        ...
        exp_total_omegas = {(None, 0.6137056388801096): {'nt_events': 1, 'value': 1},
                            (None, 1.6294456766354635): {'nt_events': 1, 'value': 1.6294456766354635},
                            (0.04044355511945654, None): {'nt_events': 1, 'value': 0.04044355511945654},
                            (0.6137056388801096, 1.6294456766354635): {'nt_events': 1,
                                                                       'value': 1.6294456766354635},
                            (3.888337029906392, 1.6294456766354635): {'nt_events': 1,
                                                                      'value': 6.335833962682549}}
        ...
        exp_sub_rates = {'A': 2.4014039861904743e-06,
                         'C': None,
                         'G': 2.4014039861904743e-06,
                         'T': 8.004679953968247e-06}
        self.assertEqual(exp_sub_rates, nt.rates)
        exp_omega_keys = {'A': (0.6137056388801096, 1.6294456766354635),
                          'C': None,
                          'G': (0.6137056388801096, 1.6294456766354635),
                          'T': (0.6137056388801096, 1.6294456766354635)}
        self.assertEqual(exp_omega_keys, nt.omega_keys)

        exp_cat_keys = {'A': 'mu1', 'G': 'mu1', 'T': 'mu1'}
        self.assertEqual(exp_cat_keys, nt.cat_keys)
        exp_total_rate = 1.2807487926349195e-05
        self.assertEqual(exp_total_rate, nt.mutation_rate)
        self.assertEqual(exp_total_omegas, self.sequence5.total_omegas)
    ...
    def testCheckMutationRates(self):
        exp_sub_rates = [
            ...
            {'A': 5.691150267276253e-05, 'C': None, 'G': 1.944063826565763e-05, 'T': 2.3499868910910054e-05},
            {'A': None, 'C': None, 'G': None, 'T': None},
            {'A': None, 'C': None, 'G': None, 'T': None},
            {'A': None, 'C': None, 'G': None, 'T': None},
            {'A': 1.244990680753976e-05, 'C': None, 'G': 1.944063826565763e-05, 'T': 0.00011642303369138271},
            {'A': None, 'C': None, 'G': None, 'T': None},
            {'A': None, 'C': None, 'G': None, 'T': None},
            {'A': None, 'C': None, 'G': None, 'T': None}
        ]
        ...
        exp_total_rates = [
            ...
            9.985200984933022e-05,
            0,
            0,
            0,
            0.0001483135787645801,
            0,
            0,
            0
        ]
    ...
    def testOmegasInOrf(self):
        expected = {'[[0, 12]]': [0.2231587490292097,
                                  0.04044355511945654,
                                  3.888337029906392,
                                  0.140788663179826],
                    '[[4, 16]]': [0.7768412509707903,
                                  1.6294456766354635,
                                  1.6294456766354635,
                                  0.2953080545748205]}
        result = omegas_in_orf(self.sequence5)
...
class TestSequence6(unittest.TestCase):
    ...
    def testSetSubstitutionRates(self):
        ...
        self.assertEqual(exp_total_rate, nt.mutation_rate)
        exp_total_omegas = {(None,): {'nt_events': 1, 'value': 1},
                            (0.8558730398605124,): {'nt_events': 1, 'value': 0.8558730398605124},
                            (1.774131041895811,): {'nt_events': 1, 'value': 1.774131041895811},
                            (3.386294361119891,): {'nt_events': 1, 'value': 1}}
    ...
    def testCheckMutationRates(self):
        exp_sub_rates = [
            ...
            {'A': 9.249120750544072e-06, 'C': None, 'G': 1.4442582869602003e-05, 'T': 3.083040250181358e-05},
            {'A': None, 'C': None, 'G': None, 'T': None},
            {'A': None, 'C': None, 'G': None, 'T': None},
            {'A': None, 'C': None, 'G': None, 'T': None},
        ]
    ...
    def testOmegasInOrf(self):
        expected = {'[(0, 5), (6, 13)]': [0.3215297042763952,
                                          1.774131041895811,
                                          0.8558730398605124,
                                          0.3215297042763952]}
        result = omegas_in_orf(self.sequence6)

        self.assertEqual(expected, result)

    # def testAllSynValues(self):
    #     result = self.sequence6.all_syn_values('')
    #     open(r'C:\Users\chait\Documents\HexSE\out.txt', 'w').write(pformat(result))
