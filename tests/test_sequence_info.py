...
class TestSequence1(unittest.TestCase):
    ...
    def testNtInEventTree(self):
        ...
        exp_event_tree = {'to_nt':
                          {'A': {'from_nt':
                                 {'A': None,
                                  'T': {'category': {'mu1': {(0, 0, 0, 1): [t6]},
                                                     'mu2': {(0, 0, 0, 1): [t14],
                                                             (0, 0, 0, 0): [t17]},
                                                     'mu3': {(0, 0, 1, 0): [t1]},
                                                     'mu4': {(0, 0, 0, 1): [t10]}}},
                                  'C': {'category': {'mu1': {(0, 0, 0, 0): [c11]},
                                                     'mu2': {(0, 0, 0, 0): [c3],
                                                             (0, 1, 0, 0): [c16],
                                                             (1, 0, 0, 0): [c20]},
                                                     'mu3': {},
                                  ...
                                  'G': {'category': {'mu1': {(0, 1, 0, 0): [g15]},
                                                     ...
                                                     'mu4': {(0, 0, 1, 0): [g12]}}}}},
                           'T': {'from_nt':
                                 {'A': {'category': {'mu1': {(0, 0, 0, 0): [a5]},
                                                     'mu2': {(0, 0, 0, 0): [a2],
                                                             (0, 1, 0, 0): [a13]},
                                                     'mu3': {(1, 0, 0, 0): [a9]},
                                                     'mu4': {(0, 0, 0, 1): [a18]}}},
                                  'T': None,
                                  'C': {'category': {'mu1': {(1, 0, 0, 0): [c16]},
                                                     'mu2': {(1, 0, 0, 0): [c7],
                                                             (0, 0, 0, 0): [c20]},
                                                     'mu3': {(0, 0, 0, 0): [c11]},
                                                     'mu4': {}}},
                                  'G': {'category': {'mu1': {(0, 0, 1, 0): [g0]},
                                                     'mu2': {(0, 0, 1, 0): [g4]},
                                                     'mu3': {(0, 0, 0, 0): [g8],
                                                             (0, 1, 0, 0): [g12, g15],
                                                             (1, 0, 0, 0): [g19]},
                           ...
                           'G': {'from_nt':
                                 {'A': {'category': {'mu1': {},
                                                     ...
                                                     'mu4': {(0, 0, 0, 0): [a2, a5],
                                                             ...
                                                             (0, 0, 0, 1): [a13],
                                                             (0, 1, 0, 0): [a18]}}},
                                  'T': {'category': {'mu1': {(0, 0, 0, 1): [t10]},
                                                     'mu2': {(0, 0, 0, 1): [t1],
                                                             (0, 1, 0, 0): [t14]},
                                                     'mu3': {(0, 0, 0, 1): [t6],
                                                             (0, 0, 0, 0): [t17]},
                                                     'mu4': {}}},
                                  'C': {'category': {'mu1': {(0, 1, 0, 0): [c20]},
                                                     'mu2': {(0, 0, 0, 1): [c3],
                                                             (1, 0, 0, 0): [c11, c16]},
                                                     'mu3': {(0, 0, 0, 1): [c7]},
                                                     'mu4': {}}},
...
class TestSequence2(unittest.TestCase):
    ...
    def testSetSubstitutionRates(self):
        ...
        self.assertEqual(exp_sub_rates, nt.rates)
        exp_omega_keys = {'A': (0, 0, 0, 1, 0), 'C': None, 'G': (0, 1, 0, 0, 0), 'T': (0, 1, 0, 0, 0)}
        ...
        self.assertEqual(exp_sub_rates, nt.rates)
        exp_omega_keys = {'A': (0, 1, 0, 1, 0), 'C': None, 'G': (0, 1, 0, 1, 0), 'T': (0, 0, 0, 1, 1)}
        self.assertEqual(exp_omega_keys, nt.omega_keys)
        ...
        exp_event_tree = {'to_nt':
                          {'A': {'from_nt': {'A': None,
                                             ...
                                             'G': {'category': {'mu1': {},
                                                                'mu2': {},
                                                                'mu3': {}}}}},
                           'T': {'from_nt': {'A': {'category': {'mu1': {(0, 1, 0, 0, 1): [a7]},
                                                                'mu2': {},
                                                                'mu3': {}}},
                                             'T': None,
                                             'C': {'category': {'mu1': {(1, 0, 0, 1, 0): [c10]},
                                                                'mu2': {},
                                                                'mu3': {(0, 1, 0, 0, 0): [c9],
                                                                        (1, 0, 0, 0, 0): [c11]}}},
                                             'G': {'category': {'mu1': {},
                                                                'mu2': {},
                                                                'mu3': {}}}}},
                           'C': {'from_nt': {'A': {'category': {'mu1': {(0, 1, 1, 0, 0): [a6, a8]},
                                                                'mu2': {},
                                                                'mu3': {(1, 0, 0, 0, 1): [a7]}}},
                                             'T': {'category': {'mu1': {},
                                                                'mu2': {},
                                             ...
                                             'G': {'category': {'mu1': {},
                                                                'mu2': {},
                                                                'mu3': {}}}}},
                           'G': {'from_nt': {'A': {'category': {'mu1': {(0, 0, 1, 0, 1): [a7]},
                                                                'mu2': {(1, 0, 0, 0, 0): [a6],
                                                                        (0, 0, 1, 0, 0): [a8]},
                                                                'mu3': {}}},
                                             'T': {'category': {'mu1': {},
