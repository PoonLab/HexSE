...
class Seq1(unittest.TestCase):
    ...
    def testUpdateNt(self):
        ...
        expected_rates = {'A': None,
                          'C': 2.707558949252105e-05,
                          'G': 3.082954625067139e-05,
                          'T': 1.423383129162287e-05}
        self.assertEqual(expected_rates, nt_to_mutate.rates)                          
        self.sim_on_branch1.update_nucleotide_info(nt_to_mutate, new_state)
        expected_rates = {'A': 0.00010905445767820979,
                          'C': 3.2716337303462935e-05,
                          'G': None,
                          'T': 7.156995183455042e-06}
        self.assertEqual(expected_rates, nt_to_mutate.rates)
...
class Seq2(unittest.TestCase):
                                                ...
                                                'C': {'mu1': {'nt_events': 0,
                                                      ...
                                                      'mu2': {'nt_events': 2,
                                                              (1, 0): {'nt_events': 0,
                                                                       'region_weight': 0},
                                                              (1, 1): {'nt_events': 2,
                                                                       'region_weight': 0.20984884341227733,
                                                      ...
                                                      'mu6': {'nt_events': 1,
                                                              (1, 0): {'nt_events': 0,
                                                                       'region_weight': 0},
                                                              (1, 1): {'nt_events': 1,
                                                                       'region_weight': 6.103423215436677,
                              ...
                              'G': {'from_nt': {'A': {'mu1': {'nt_events': 1,
                                                      ...
                                                      'mu2': {'nt_events': 1,
                                                              (1, 0): {'nt_events': 0,
                                                                       'region_weight': 0},
                                                              (1, 1): {'nt_events': 1,
                                                                       'region_weight': 2.630613147647709,
                                                ...
                                                'C': {'mu1': {'nt_events': 0,
                                                      ...
                                                      'mu4': {'nt_events': 2,
                                                              (1, 0): {'nt_events': 0,
                                                                       'region_weight': 0},
                                                              (1, 1): {'nt_events': 2,
                                                                       'region_weight': 6.240376998081334,
                                                                       (0.04044355511945654, 3.386294361119891): [c9],
                                                                       (3.386294361119891, 1.8023900359974012): [c11]}},
                                                      'mu5': {'nt_events': 0,
                                                              (1, 0): {'nt_events': 0,
    ...
    def testUpdateNt(self):
        ...
        expected_rates = {'A': None,
                          'C': 4.6741048290007206e-07,
                          'G': 3.692427860231864e-05,
                          'T': 2.423256139507168e-06}
...
class Seq3(unittest.TestCase):
    ...
    def testUpdateNt(self):
        ...
        expected_rates = {'A': 3.808218343817915e-07,
                          'C': None,
                   ...
                   {'to_nt': {'A': {'from_nt': {'A': None,
                              ...
                              'G': {'from_nt': {'A': {'mu1': {'nt_events': 0,
                                                ...
                                                'C': {'mu1': {'nt_events': 0,
                                                      ...
                                                      'mu5': {'nt_events': 2,
                                                              (1,): {'nt_events': 2,
                                                                     'region_weight': 4.242167400980403,
                                                                     (0.8558730398605124,): [c6],
                                                                     (3.386294361119891,): [c8]}},
                                                      'mu6': {'nt_events': 0,
                                                              (1,): {'nt_events': 0,
...
class Seq5(unittest.TestCase):
    ...
    def testUpdateNt(self):
        ...
        expected_rates = {'A': 0.00010060390142109391,
                          'C': None,
                          'G': 0.00010060390142109391,
                          'T': 0.00018989527647629136}
