...
def apply_omega(seq, omega, sub_kind, rates):
    """
    Apply omega values to tupple generated by evol_rates
    @param omega: a List of dN/dS (omega) ratios along sequence length as {dict}.
    @param sub_kind: Output from get_syn_subs
    @param rates: output from evol_rates
    @param seq: sequence
    """
