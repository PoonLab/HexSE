# Simulate evolution in a sequence with overlappin reading frames according to the new data structure from new_sequence_info.py

class Simulate:
    """
    Simulate evolution within a sequence troughout a phylogeny
